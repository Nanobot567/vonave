...
| pxe A                 | set pixel x to A                                                                                                                                               | 1         |                  | 26     |
| pxi                   | increment pixel x                                                                                                                                              | 0         |                  | 27     |
| pxd                   | decrement pixel x                                                                                                                                              | 0         |                  | 28     |
| pxa A                 | add A to pixel x                                                                                                                                               | 1         |                  | 29     |
| pxs A                 | subtract A from pixel x                                                                                                                                        | 1         |                  | 2A     |
| pye A                 | set pixel y to A                                                                                                                                               | 1         |                  | 2B     |
| pyi                   | increment pixel y                                                                                                                                              | 0         |                  | 2C     |
| pyd                   | decrement pixel y                                                                                                                                              | 0         |                  | 2D     |
| pya A                 | add A to pixel y                                                                                                                                               | 1         |                  | 2E     |
| pys A                 | subtract A from pixel y                                                                                                                                        | 1         |                  | 2F     |
| point                 | set pixel at pixel position to current draw color                                                                                                              | 0         |                  | 30     |
| line A,B              | draw line from current pixel position to x A, y B                                                                                                              | 2         |                  | 31     |
| rect A,B              | draw rect (top left corner at current pixel position) with width A and height B                                                                                | 2         |                  | 32     |
| frect A,B             | fill rect from current pixel position with width A, height B                                                                                                   | 2         |                  | 33     |
| char A                | draw glyph assigned to hex code A at current pixel position                                                                                                    | 1         |                  | 34     |
| charw A               | draw glyph assigned to hex code A at current pixel position, and update pixel position to reflect glyph width (including y position if at the edge of display) | 1         |                  | 35     |
